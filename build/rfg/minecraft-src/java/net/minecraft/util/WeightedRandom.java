...
public class WeightedRandom
{
     ...
     */
    public static WeightedRandom.Item getRandomItem(Random p_76273_0_, Collection<? extends net.minecraft.util.WeightedRandom.Item> p_76273_1_, int p_76273_2_)
    {
        if (p_76273_2_ <= 0)
        {
    ...
    public static WeightedRandom.Item getItem(Collection<? extends net.minecraft.util.WeightedRandom.Item> par1Collection, int weight)
    {
        {
            int j = weight;
     ...
     */
    public static WeightedRandom.Item getRandomItem(Random p_76271_0_, Collection<? extends net.minecraft.util.WeightedRandom.Item> p_76271_1_)
    {
